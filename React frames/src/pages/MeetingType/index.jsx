    ...
    <>
      <div className="bg-black-900 font-poppins h-[982px] mx-auto pt-[85px] relative w-full">
        ...
        <div className="absolute bottom-[0] h-[897px] inset-x-[0] mx-auto md:px-5 w-full">
          <div className="bg-gray-900_bf border border-gray-800 border-solid flex flex-col items-center justify-start mb-[undefinedpx] mt-[50px] mx-auto p-[23px] sm:px-5 rounded-[40px] w-4/5 z-[1]">
          ...
          <div className="flex md:flex-col flex-row font-kollektif md:gap-5 items-start justify-center ml-auto mr-[0] mt-[-720px] w-[72%] z-[1]">
            <Text
            ...
            <Text
              className="md:ml-[0] ml-[21px] md:mt-0 mt-1 sm:text-[31px] md:text-[33px] text-[35px] text-white-A700 w-[250px]"
              size="txtKollektif35"
            >
              Hosted Meetings
            </Text>
            ...
            <Text
              className="md:ml-[0] ml-[21px] md:mt-0 mt-1 sm:text-[31px] md:text-[33px] text-[35px] text-white-A700 w-[270px]"
              size="txtKollektif35"
            >
              Attended Meetings
            </Text>
          ...
          <Img
            className="h-[68px] mb-[125px] ml-8 object-cover w-[23%] z-[1]"
