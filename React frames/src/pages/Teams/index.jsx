    ...
    <>
      <div className="bg-black-900 font-poppins h-[982px] mx-auto pt-[85px] relative w-full">
        ...
        <div className="absolute bottom-[0] h-[897px] inset-x-[0] mx-auto md:px-5 w-full">
          <div className="bg-gray-900_bf border border-gray-800 border-solid flex flex-col items-end justify-start mb-[undefinedpx] mt-5 mx-auto pl-[19px] py-[19px] rounded-[40px] w-4/5 z-[1]">
            <div className="flex flex-col md:gap-10 gap-16 justify-start mb-24 w-[96%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row font-kollektif md:gap-5 items-start justify-evenly w-full">
                ...
                <Img
                  className="h-[70px] md:h-auto md:mt-0 mt-[115px] object-cover w-[70px]"
          ...
          <div className="flex md:flex-col flex-row font-kollektif md:gap-5 items-start justify-center mb-[-15px] ml-auto mr-[89px] mt-[-700px] w-[72%] z-[1]">
            <Text
            ...
            <Text
              className="common-pointer md:ml-[0] ml-[21px] md:mt-0 mt-1 sm:text-[31px] md:text-[33px] text-[35px] text-white-A700 w-[250px]"
              size="txtKollektif35"
              onClick={() => navigate("/hostedmeetings")}
            >
              Hosted Meetings
          ...
          <Img
            className="h-[68px] mb-[0] ml-2.5 object-cover w-[23%] z-[1]"
            src="images/img_logo.png"
            alt="logo"
          />
          <div className="flex flex-col gap-[50px] justify-start mt-auto mx-auto w-full">
            <Img
              className="h-[367px] md:h-auto object-cover opacity-0 w-[23%]"
