  ...
  return (
    <>
      <div className="bg-black-900 flex flex-col font-poppins gap-[23px] justify-start mx-auto w-full">
        <div className="flex flex-col items-center w-full">
          <div className="flex flex-col md:px-5 relative w-full">
            <div className="h-[1089px] md:h-[NaNpx] ml-auto mt-[-NaNpx] w-[86%] md:w-full z-[1]">
              ...
              <div className="absolute flex flex-col h-max inset-y-[0] items-start justify-start my-auto right-[8%] w-[74%]">
                <Text
                ...
                <Line className="bg-white-A700 h-px mt-[7px] w-full" />
                <div className="sm:h-[867px] md:h-[936px] h-[93px] mt-[774px] relative w-full">
            ...
            <div className="flex flex-col items-start justify-start ml-auto mr-[103px] mt-[-NaNpx] w-[64%] z-[1]">
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[99%] md:w-full">
                ...
                <Img
                  className="h-[47px] md:h-auto md:ml-[0] ml-[623px] object-cover w-[47px]"
                  src="images/img_sort1.png"
                  alt="sortOne"
                />
                <Text
                  className="md:ml-[0] ml-[11px] md:mt-0 mt-[3px] sm:text-[28.619999999999997px] md:text-[30.619999999999997px] text-[32.62px] text-white-A700"
              ...
              >
                ...
                <div className="md:h-[136px] sm:h-[93px] h-[94px] relative w-full">
                  <div className="absolute bg-blue_gray-100_21 flex md:flex-col flex-row font-kollektif gap-[17px] h-max inset-[0] items-start justify-center m-auto p-[26px] sm:px-5 rounded-[12px] w-full">
                    <Text
                      className="md:ml-[0] ml-[194px] md:mt-0 mt-[5px] sm:text-[24.55px] md:text-[26.55px] text-[28.55px] text-white-A700"
                      size="txtKollektif2855"
                    >
              ...
              <div className="sm:h-[116px] md:h-[179px] h-[93px] mt-[23px] relative w-full">
                <div className="absolute bg-blue_gray-100_21 flex md:flex-col flex-row font-kollektif gap-[39px] h-full inset-[0] items-center justify-center m-auto p-[25px] sm:px-5 rounded-[12px] w-full">
                  <Text
                    className="md:mt-0 mt-[7px] sm:text-[24.55px] md:text-[26.55px] text-[28.55px] text-white-A700"
                    size="txtKollektif2855"
                  >
                ...
                <Text
                  className="absolute bg-blue_gray-100_21 h-full inset-y-[0] justify-center left-[0] my-auto sm:px-5 px-[35px] py-[25px] rounded-bl-[12px] rounded-tl-[12px] sm:text-[24.55px] md:text-[26.55px] text-[28.55px] text-white-A700 w-[200px]"
              ...
              <div className="sm:h-[111px] md:h-[182px] h-[93px] mt-[18px] relative w-full">
                ...
                <Text
                  className="absolute bg-blue_gray-100_21 h-full inset-y-[0] justify-center left-[0] my-auto pb-[23px] pt-[27px] sm:px-5 px-[35px] rounded-bl-[12px] rounded-tl-[12px] sm:text-[24.55px] md:text-[26.55px] text-[28.55px] text-white-A700 w-[200px]"
                  size="txtPoppinsRegular2855"
                >
                  11 July
                </Text>
            ...
            <div className="md:h-[118px] sm:h-[47px] h-[93px] ml-auto mr-[103px] mt-[-46px] w-[64%] md:w-full z-[1]">
              <div className="absolute bg-blue_gray-100_21 flex md:flex-col flex-row font-kollektif gap-[45px] h-full inset-[0] items-center justify-center m-auto p-6 sm:px-5 rounded-[12px] w-full">
                <Text
                  className="md:mt-0 my-1 sm:text-[24.55px] md:text-[26.55px] text-[28.55px] text-white-A700"
                  size="txtKollektif2855"
            ...
            <div className="flex md:flex-col flex-row font-kollektif md:gap-10 items-start justify-between mt-[-NaNpx] mx-auto w-full z-[1]">
              <div className="bg-gray-900_3d border border-gray-800 border-solid flex flex-col items-center justify-start p-[11px] rounded-[40px]">
                <Img
        ...
        <div className="flex flex-col items-end md:px-10 sm:px-5 px-[103px] w-full">
          <List
